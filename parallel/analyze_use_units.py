...
# --------------------------------------------------------------------------------------------------
# python analyze_use_units vector_add warp_unit
...
#	input_parameter = "warp_unit" 					# replace for input argument
	...
	address_file_name1 = fault_model + "/" + input_parameter + "/" + application_name + "/inst_classification_operand.txt_test.txt"
	...
	input_file1 = open(address_file_name1, 'r')
	...
	for line in input_file1:
		...
		print(inst_type, op_param, line)
		
		total_inst = total_inst + 1
		
		if inst_type == "A_L" or inst_type == "A_L\r" or inst_type == "A_L\n":
		
			if op_param == "FPU" or op_param == "FPU\r\n" or op_param == "FPU\r" or op_param == "FPU\n":
				total_arith_FPU = total_arith_FPU + 1
				
			elif op_param == "INT" or op_param == "INT\r\n" or op_param == "INT\r" or op_param == "INT\n":
				total_arith_INT = total_arith_INT + 1

			total_arith = total_arith + 1

		elif inst_type == "CF" or inst_type == "CF\r" or inst_type == "CF\n":
			total_control = total_control + 1
			
		elif inst_type == "DH_M" or inst_type == "DH_M\r" or inst_type == "DH_M\n":		
			total_data_mem = total_data_mem + 1
	
	print("Control: " + str(total_control) )
	print("arith: " + str(total_arith) )
	print("arith INT: " + str(total_arith_INT) )
	print("arith FPU: " + str(total_arith_FPU) )
	print("Data: " + str(total_data_mem) )
	print("total inst: " + str(total_inst) )
