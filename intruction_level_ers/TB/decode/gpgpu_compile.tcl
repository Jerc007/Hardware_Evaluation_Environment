...
set gpgpu_vhdls [list \
	...
	"## Package" \
	"$GPGPU_GENERIC_ROOT/gpgpu_package_decode.vhd" \
	...
	"## SMP" \
	"$GPGPU_GENERIC_ROOT/SMP/streaming_multiprocessor_decode.vhd" \
	"## Block Scheduler" \
...
vlog     ../../GL/decode/pipeline_decode.v
...
vcd dumpports tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineDecode/* -file dumpports_decode.vcd
