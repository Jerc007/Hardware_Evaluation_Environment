...
set gpgpu_vhdls [list \
	...
	"## Package" \
	"$GPGPU_GENERIC_ROOT/gpgpu_package_fetch.vhd" \
	...
	"## Pipeline - Fetch" \
	"## $GPGPU_GENERIC_ROOT/../../GL/fetch/fetch_15.v" \
	"## Pipeline - Read" \
	...
	"## SMP" \
	"$GPGPU_GENERIC_ROOT/SMP/streaming_multiprocessor_fetch.vhd" \
	"## Block Scheduler" \
...
vlog 	 ../../GL/NanGate_15nm_OCL_functional.v
vlog     ../../GL/fetch/pipeline_fetch.v
...
vcd dumpports tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineFetch/* -file dumpports_fetch.vcd
