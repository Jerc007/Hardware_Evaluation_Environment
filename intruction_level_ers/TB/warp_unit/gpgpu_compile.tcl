#!/usr/bin/tclsh
set GPGPU_GENERIC_ROOT "../4.4_FlexGripPlus/FlexGripPlus_Pro_ed/RTL"
quit -sim
...
set gpgpu_vhdls [list \
	...
	"## Package" \
	"$GPGPU_GENERIC_ROOT/gpgpu_package_warp.vhd" \
	...
	"## SMP" \
	"$GPGPU_GENERIC_ROOT/SMP/streaming_multiprocessor_warp.vhd" \
	"## Block Scheduler" \
...
vlog 	 ../../GL/15nm/verilog/NanGate_15nm_OCL_functional.v
vlog     ../../GL/warp_scheduler/dp_regfile_verilog.v
vlog     ../../GL/warp_scheduler/warp_unit_15.v
...
vcd dumpports tb_top_level/uGPGPU/uStreamingMultiProcessor/uWarpUnit/* -file dumpports_warp_unit.vcd
