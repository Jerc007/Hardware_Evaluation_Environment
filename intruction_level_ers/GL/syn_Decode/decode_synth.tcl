...
set gpgpu_vhdls [list \
	"$GPGPU_GENERIC_ROOT/RTL/decoder/pick_bench.vhd" \
	"$GPGPU_GENERIC_ROOT/RTL/decoder/gpgpu_package.vhd" \
	"$GPGPU_GENERIC_ROOT/RTL/decoder/pipeline_decode.vhd"
]
...
write -f verilog -hierarchy -output decode_45.v

report_timing -transition_time -nets -attributes -nosplit > Report_time_transition_45.txt
report_timing -delay max -nosplit > Report_time_delay_max_45.txt
report_timing -path full -nosplit > Report_time_path_full_45.txt

report_area -nosplit -hierarchy > Report_Area_45.txt
report_power -nosplit -hierarchy > Report_Power_45.txt
report_reference -nosplit -hierarchy > Report_References_45.txt
report_resources -nosplit -hierarchy > Report_Resources_45.txt
report_cell > Report_Cells_45.txt
